...
DebugDraw::DebugDraw(sf::RenderTarget &target) : target(target) {
...
void DebugDraw::DrawTransform(const b2Transform& xf) {    
    ...
    //p2 = p1 + k_axisScale * xf.q;
    
    sf::Shape Point = sf::Shape::Line(p1.x*PIXELS_PER_METER, p1.y*PIXELS_PER_METER, p2.x*PIXELS_PER_METER, p2.y*PIXELS_PER_METER, 1.f, sf::Color(255, 255, 255));
    target.Draw(Point);
    
    
    p2 = p1 + k_axisScale * xf.q;
    sf::Shape Line2 = sf::Shape::Line(p1.x*PIXELS_PER_METER, p1.y*PIXELS_PER_METER, p2.x*PIXELS_PER_METER, p2.y*PIXELS_PER_METER, 1.f, sf::Color(255, 255, 255));
    target.Draw(Line2);*/
}
